...
function init(options = {}) {
  ...
  if (options.release === undefined) {
    ...
    if (utils.WINDOW.SENTRY_RELEASE && utils.WINDOW.SENTRY_RELEASE.id) {
      options.release = utils.WINDOW.SENTRY_RELEASE.id;
    }
  }
...
function showReportDialog(options = {}, hub = core.getCurrentHub()) {
  ...
  const script = utils.WINDOW.document.createElement('script');
  script.async = true;
  ...
  const injectionPoint = utils.WINDOW.document.head || utils.WINDOW.document.body;
  if (injectionPoint) {
...
function startSessionTracking() {
  if (typeof utils.WINDOW.document === 'undefined') {
