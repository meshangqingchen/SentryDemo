   ...
   */
   setupOnce() {
    if (this._options.setTimeout) {
      utils.fill(utils.WINDOW, 'setTimeout', _wrapTimeFunction);
    }

    if (this._options.setInterval) {
      utils.fill(utils.WINDOW, 'setInterval', _wrapTimeFunction);
    }

    if (this._options.requestAnimationFrame) {
      utils.fill(utils.WINDOW, 'requestAnimationFrame', _wrapRAF);
    }

    if (this._options.XMLHttpRequest && 'XMLHttpRequest' in utils.WINDOW) {
...
function _wrapEventTarget(target) {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const globalObject = utils.WINDOW ;
  // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
