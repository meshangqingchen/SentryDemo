...
class Offline  {
   ...
   */
   setupOnce(addGlobalEventProcessor, getCurrentHub) {
    ...
    if ('addEventListener' in utils.WINDOW) {
      utils.WINDOW.addEventListener('online', () => {
    ...
    const eventProcessor = event => {
      if (this.hub && this.hub.getIntegration(Offline)) {
        ...
        if ('navigator' in utils.WINDOW && 'onLine' in utils.WINDOW.navigator && !utils.WINDOW.navigator.onLine) {
